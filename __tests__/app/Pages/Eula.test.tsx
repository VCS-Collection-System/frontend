...
describe("Eula Page", () =>{
    ...
    it("should render without crashing", () => {
        const wrapper = shallow(<Eula login={mocked_keycloak.login} />)
        expect(Eula)
    })
    ...
    it("Should display the EULA text", async () => {
        const eula = mount(<Eula login={mocked_keycloak.login} />);
        expect(eula.text().includes("VCS Privacy Notice")).toBeTruthy();
    });
